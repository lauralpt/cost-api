 ...
 * This class uses {@code @ControllerAdvice} to capture and handle specific exceptions
 * in a centralized way, allowing for greater consistency and simplicity.
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
         ...
         * @return An HTTP response with status code {@code 404 NOT FOUND} and a body containing error details.
         */
    ...
    /**
     * Handles exceptions related to invalid method arguments, such as
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        // Maps validation errors and adds them to the response body
     ...
     /**
     * Handles general exceptions that are not specifically managed by other handlers.
